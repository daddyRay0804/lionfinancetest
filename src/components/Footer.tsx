...
import { nav, productSlugs, productTitles, siteName, siteTagline, contactAddress, contactEmail, footerLegalSlugs, footerLegal } from "@/data/content";
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-10 sm:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-8">
          <div>
            ...
            <p className="text-sm text-white/80">{siteTagline[lang]}</p>
          ...
          <div>
            <h3 className="text-sm font-semibold text-lion-gold mb-3">{nav.products[lang]}</h3>
          ...
          <div>
            <h3 className="text-sm font-semibold text-lion-gold mb-3">{nav.contact[lang]}</h3>
