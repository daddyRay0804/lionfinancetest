      ...
      <div className="max-w-3xl mx-auto text-lion-dark [&_a]:text-lion-gold [&_a]:hover:underline [&_a]:break-all">
        ...
        <section className="mb-10">
          ...
          <p className="mb-4 leading-relaxed">
            Lion Financial Services Limited (we, us, our) complies with the New Zealand Privacy Act 2020 (the Act) when dealing with personal information. Personal information is information about an identifiable individual (a natural person). This policy sets out how we will collect, use, disclose, and protect your personal information.
          </p>
          <p className="leading-relaxed">
            This policy does not limit or exclude any of your rights under the Act. If you wish to seek further information on the Act, you can contact our Privacy Officer by email at{" "}
            <a href="mailto:gary@lionfinance.co.nz">gary@lionfinance.co.nz</a>. Or visit{" "}
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-6 space-y-1 mb-4">
            ...
            <li>Other companies or individuals who perform checks (such as but not limited to compliance reviews and audits) that are necessary or desirable under the law on our behalf;</li>
            <li>Other companies, agencies, or individuals that maintain databases against which your identity may be verified, which may include (but are not limited to) the New Zealand Department of Internal Affairs, and New Zealand Transport Agency;</li>
            <li>Social media sites on which we may have a presence;</li>
            <li>Courts, tribunals, and regulatory authorities (such as the Financial Markets Authority, and the Ministry of Justice in New Zealand);</li>
            ...
            <li>Overseas privacy regulator, where a complaint relates to the actions of an overseas agency; and</li>
        ...
        <section className="mb-10">
          ...
          <p className="leading-relaxed">
            ...
            <a href="mailto:gary@lionfinance.co.nz">gary@lionfinance.co.nz</a>. Your email should provide evidence of who you are and set out the details of your request (e.g. the personal information, or the correction, that you are requesting).
          </p>
        </section>
